				...
				var items = [];
				  $('.a').attr("checked" , false).each(function (){
					  ...
					  $(result).each(function(index , item){
							if(p == item.sit  && item.sitlevel =="A" && item.play == "BASEBALL"){		
...
<li class="seat">
<input type="checkbox" name="row1" class="a" value="5E" id="5E"/>
<label for="5E">5E</label>
</li>
<li class="seat">
<input type="checkbox" name="row1" class="a" value="5F" id="5F"/>
...
<li class="seat">
<input type="checkbox" name="row1" class="a" value="6E" id="6E"/>
<label for="6E">6E</label>
</li>
<li class="seat">
<input type="checkbox" name="row1" class="a" value="6F" id="6F"/>
...
<li class="seat">
<input type="checkbox" name="row1" class="a" value="7E" id="7E"/>
<label for="7E">7E</label>
</li>
<li class="seat">
<input type="checkbox" name="row1" class="a" value="7F" id="7F"/>
