...
<link rel="shortcut icon" type="image/x-icon"
	href="/olympic/resources/images/favicon.png" />
	...
	function getseatprice() {
		...
		$.ajax({
			...
			success : function(result) {
				...
				document.getElementById("selectseat").removeAttribute(
						"disabled");
			}
		})
	}

	function selectseat2() {
		location.href = "/olympic/tiket/selectseat2?play=BASKETBALL&stadium="
				+ "${stadium}" + "&playdate=" + "${playdate}" + "&sitlevel="
				+ $('#seat').val();
	}
</script>
<style type="text/css">
	...
	<div class="bg">
		<div class="main">
			<header>
				...
				<div id="roww">
					<img src="/olympic/resources/images/basketballl.png"><br />
					<div id="rowww">
						...
						<div id="seat_pr"></div>
						<button type="button" onclick="selectseat2()" id="selectseat"
