				...
				<div class="row-2">
					<nav>
						<ul class="menu">
							...
							<li class="last-item"><a class="active" href="contacts">Contact Us</a></li>
						</ul>
					</nav>
				</div>
				<div class="row-3">
					<div class="slider-wrapper">
						<div class="slider">
							...
							<div style="padding:100px 20px;text-align:left;">
								<table style="margin:auto;">
									<tr><td>一般問合せ</td></tr>
									<tr><td>マーケティング広報 / ホームページの利用お問い合わせ</td></tr>
									<tr><td>subin@naver.com</td></tr>
									<tr><td style="height:15px"></td></tr>
									<tr><td style="height:15px"></td></tr>
									<tr><td style="height:15px"></td></tr>
									<tr><td>メンテナンス問合せ</td></tr>
									<tr><td>seyeon@sesoc.com</td></tr>
								</table>
							</div>
						</div>
					</div>
